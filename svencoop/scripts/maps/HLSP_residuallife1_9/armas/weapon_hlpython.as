...
class weapon_hlpython : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  bool Deploy()
  {
    ...
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/residuallife/weapons/sd/v_357.mdl'), self.GetP_Model('models/valve/sd/p_357.mdl'), DRAW, 'python', 0, pev.body);
