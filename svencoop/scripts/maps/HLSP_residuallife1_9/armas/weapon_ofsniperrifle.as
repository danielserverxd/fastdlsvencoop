...
class weapon_ofsniperrifle : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model('models/valve/sd/w_m40a1.mdl'));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/residuallife/weapons/sd/v_m40a1.mdl');
    g_Game.PrecacheModel('models/valve/sd/w_m40a1.mdl');
    g_Game.PrecacheModel('models/valve/sd/p_m40a1.mdl');
  ...
  bool Deploy()
  {
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/residuallife/weapons/sd/v_m40a1.mdl'), self.GetP_Model('models/valve/sd/p_m40a1.mdl'), DRAW, 'sniper');
