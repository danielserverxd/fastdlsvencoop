...
class weapon_ofm249 : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model('models/valve/sd/w_saw.mdl'));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/residuallife/weapons/sd/v_saw.mdl');
    g_Game.PrecacheModel('models/valve/sd/w_saw.mdl');
    g_Game.PrecacheModel('models/valve/sd/p_saw.mdl');

    m_iShell = g_Game.PrecacheModel('models/valve/sd/saw_shell.mdl');
  ...
  bool Deploy()
  {
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/residuallife/weapons/sd/v_saw.mdl'), self.GetP_Model('models/valve/sd/p_saw.mdl'), DRAW, 'saw', 0, pev.body);
