...
string W_MODEL		= "models/hrafd/w_357.mdl";
string V_MODEL		= "models/hrafd/v_357.mdl";
string P_MODEL		= "models/hrafd/p_357.mdl";

string SPR_DIR		= "hrafd/";

array<string> Sounds = { 
		          "hrafd/weapons/revolver1.wav",
		          "hrafd/weapons/revolver2.wav",
		          "hrafd/null/null.wav", 
		          "hrafd/null/null.wav"
};
...
class weapon_hrpython : ScriptBasePlayerWeaponEntity
{
...
{
	return "weapon_hrpython";
}

void RegisterPython()
{	
	g_CustomEntityFuncs.RegisterCustomEntity( "HR_PYTHON::weapon_hrpython", GetPythonName() );
	g_ItemRegistry.RegisterWeapon( GetPythonName(), "hrafd", "357" );
}
