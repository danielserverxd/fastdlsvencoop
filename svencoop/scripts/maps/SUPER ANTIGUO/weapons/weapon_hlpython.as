...
class weapon_hlpython : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model('models/bshift_sd/w_357.mdl'));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/bshift_sd/v_357.mdl');
    g_Game.PrecacheModel('models/bshift_sd/w_357.mdl');
    g_Game.PrecacheModel('models/bshift_sd/p_357.mdl');
  ...
  bool Deploy()
  {
    ...
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/bshift_sd/v_357.mdl'), self.GetP_Model('models/bshift_sd/p_357.mdl'), DRAW, 'python', 0, pev.body);
