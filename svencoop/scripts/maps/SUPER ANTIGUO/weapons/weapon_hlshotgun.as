...
class weapon_hlshotgun : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/bshift_sd/w_shotgun.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/bshift_sd/v_shotgun.mdl" );
		g_Game.PrecacheModel( "models/bshift_sd/w_shotgun.mdl" );
		g_Game.PrecacheModel( "models/bshift_sd/p_shotgun.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/bshift_sd/v_shotgun.mdl" ), self.GetP_Model( "models/bshift_sd/p_shotgun.mdl" ), SHOTGUN_DRAW, "shotgun" );
	}
