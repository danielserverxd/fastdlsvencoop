...
class weapon_ofeagle : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model('models/bshift_sd/w_desert_eagle.mdl'));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/bshift_sd/v_desert_eagle.mdl');
    g_Game.PrecacheModel('models/bshift_sd/w_desert_eagle.mdl');
    g_Game.PrecacheModel('models/bshift_sd/p_desert_eagle.mdl');
  ...
  bool Deploy()
  {
    ...
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/bshift_sd/v_desert_eagle.mdl'), self.GetP_Model('models/bshift_sd/p_desert_eagle.mdl'), DRAW, 'onehanded');
