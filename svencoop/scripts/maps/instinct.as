...
void MapStart()
{
	if( !ANTI_RUSH::IsActive() )
		ANTI_RUSH::AREntityRemove( "percent_lock_*;models/cubemath/*;blocker_wall*" );

	if( g_Engine.mapname == "instinct_9" )
		g_Scheduler.SetInterval( "BlockerThink", 0.1f, -1 );

	g_EngineFuncs.ServerPrint( "Half-Life: Instinct - Download this campaign from scmapdb.com\n" );
}
// Horrendous code incoming
array<Vector> old_ply_posis( g_Engine.maxClients + 1 ),
play_area_instinct_9 = {
...
void BlockerThink()
{
  ...
  for( int iPlayer = 1; iPlayer <= g_Engine.maxClients; ++iPlayer )
  {
    ...
    g_EntityFuncs.SetOrigin( pPlayer, old_ply_posis[iPlayer] );
  }
}
