...
class weapon_ofshockrifle : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model('models/valve/sd/w_shock_rifle.mdl'));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/valve/sd/v_shock.mdl');
    g_Game.PrecacheModel('models/valve/sd/w_shock_rifle.mdl');
    g_Game.PrecacheModel('models/valve/sd/p_shock.mdl');
  ...
  bool Deploy()
  {
    ...
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/valve/sd/v_shock.mdl'), self.GetP_Model('models/valve/sd/p_shock.mdl'), DRAW, 'bow');
