...
class weapon_ofm249 : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/blkops/sd/v_saw.mdl');
  ...
  bool Deploy()
  {
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/blkops/sd/v_saw.mdl'), self.GetP_Model('models/valve/sd/p_saw.mdl'), DRAW, 'saw', 0, pev.body);
