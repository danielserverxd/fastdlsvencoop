...
class weapon_ofeagle : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/blkops/sd/v_desert_eagle.mdl');
  ...
  bool Deploy()
  {
    ...
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/blkops/sd/v_desert_eagle.mdl'), self.GetP_Model('models/valve/sd/p_desert_eagle.mdl'), DRAW, 'onehanded');
