...
class weapon_hlpython : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/opfor/sd/v_357.mdl');
  ...
  bool Deploy()
  {
    ...
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/opfor/sd/v_357.mdl'), self.GetP_Model('models/hlclassic/p_357.mdl'), DRAW, 'python', 0, pev.body);
