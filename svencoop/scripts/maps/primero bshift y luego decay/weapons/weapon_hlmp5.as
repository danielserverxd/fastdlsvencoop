...
class weapon_hlmp5 : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/bshift_sd/w_9mmAR.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/bshift_sd/v_9mmAR.mdl" );
		g_Game.PrecacheModel( "models/bshift_sd/w_9mmAR.mdl" );
		g_Game.PrecacheModel( "models/bshift_sd/p_9mmAR.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/bshift_sd/v_9mmAR.mdl" ), self.GetP_Model( "models/bshift_sd/p_9mmAR.mdl" ), MP5_DEPLOY, "mp5" );
	}
