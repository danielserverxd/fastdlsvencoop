...
class weapon_hlcrowbar : ScriptBasePlayerWeaponEntity
{
	...
	{
		self.Precache();
		g_EntityFuncs.SetModel( self, self.GetW_Model( "models/bshift_sd/w_crowbar.mdl") );
		self.m_iClip			= -1;
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/bshift_sd/v_crowbar.mdl" );
		g_Game.PrecacheModel( "models/bshift_sd/w_crowbar.mdl" );
		g_Game.PrecacheModel( "models/bshift_sd/p_crowbar.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/bshift_sd/v_crowbar.mdl" ), self.GetP_Model( "models/bshift_sd/p_crowbar.mdl" ), CROWBAR_DRAW, "crowbar" );
	}
