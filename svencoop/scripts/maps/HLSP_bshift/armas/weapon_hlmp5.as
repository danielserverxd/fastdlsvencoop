...
class weapon_hlmp5 : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/bshift/v_m16a2.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/bshift/v_m16a2.mdl" ), self.GetP_Model( "models/hl/p_9mmAR.mdl" ), MP5_DEPLOY, "mp5" );
	}
