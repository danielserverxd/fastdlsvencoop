...
class weapon_hlshotgun : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/bshift/hd/v_shotgun.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/bshift/hd/v_shotgun.mdl" ), self.GetP_Model( "models/hl/p_shotgun.mdl" ), SHOTGUN_DRAW, "shotgun" );
	}
