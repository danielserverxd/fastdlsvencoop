...
class weapon_hlpython : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model('models/valve/hd/w_357.mdl'));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/decay/hd/v_357.mdl');
    g_Game.PrecacheModel('models/valve/hd/w_357.mdl');
    g_Game.PrecacheModel('models/valve/hd/p_357.mdl');
  ...
  bool Deploy()
  {
    ...
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/decay/hd/v_357.mdl'), self.GetP_Model('models/valve/hd/p_357.mdl'), DRAW, 'python', 0, pev.body);
