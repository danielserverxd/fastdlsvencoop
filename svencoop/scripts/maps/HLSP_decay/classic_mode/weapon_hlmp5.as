...
class weapon_hlmp5 : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/decay/hd/v_9mmAR.mdl" );
		...
		g_Game.PrecacheModel( "models/valve/hd/grenade.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/decay/hd/v_9mmAR.mdl" ), self.GetP_Model( "models/valve/hd/p_9mmAR.mdl" ), MP5_DEPLOY, "mp5" );
	}
