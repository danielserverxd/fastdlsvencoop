...
class weapon_sawedoff : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/portal_house/w_sawedoff.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/portal_house/v_sawedoff.mdl" );
		g_Game.PrecacheModel( "models/portal_house/w_sawedoff.mdl" );
		g_Game.PrecacheModel( "models/portal_house/p_sawedoff.mdl" );

		m_iShell = g_Game.PrecacheModel( "models/shotgunshell.mdl" );// shotgun shell

		g_SoundSystem.PrecacheSound( "portal_house/weapons/sawedoff_fire.wav" );
		g_SoundSystem.PrecacheSound( "portal_house/weapons/sawedoff_pump.wav" );
		g_SoundSystem.PrecacheSound( "portal_house/weapons/sawedoff_reload1.wav" );
		g_SoundSystem.PrecacheSound( "portal_house/weapons/sawedoff_reload2.wav" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/portal_house/v_sawedoff.mdl" ), self.GetP_Model( "models/portal_house/p_sawedoff.mdl" ), SAWEDOFF_DEPLOY, "shotgun" );
	}
	...
	void PrimaryAttack()
	{
		...
		g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "portal_house/weapons/sawedoff_fire.wav", Math.RandomFloat( 0.95, 1.0 ), ATTN_NORM, 0, 93 + Math.RandomLong( 0, 0x1f ) );
	...
	void Reload()
	{
		...
		else if( m_fShotgunReload )
		{
			...
			{
			case 0:
				g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_ITEM, "portal_house/weapons/sawedoff_reload1.wav", 1, ATTN_NORM, 0, 85 + Math.RandomLong( 0, 0x1f ) );
				break;
			case 1:
				g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_ITEM, "portal_house/weapons/sawedoff_reload2.wav", 1, ATTN_NORM, 0, 85 + Math.RandomLong( 0, 0x1f ) );
				break;
			}
		}
...
void RegisterSawedOff()
{
	...
	g_ItemRegistry.RegisterWeapon( GetSawedOffName(), "portal_house", "buckshot" );
}
