...
const string DL44_SOUND_DRAW		= "portal_house/selectRifleBlaster.wav";
const string DL44_SOUND_FIRE		= "portal_house/weapons/xs_shot.wav";
const string DL44_SOUND_EXPLODE		= "portal_house/hit_wallRifleBlaster.wav";
const string DL44_SOUND_DRYFIRE		= "portal_house/dryfire.wav";

const string DL44_MODEL_NULL		= "models/portal_house/p_dl44Null.mdl";
const string DL44_MODEL_VIEW		= "models/portal_house/v_xs.mdl";
const string DL44_MODEL_PLAYER		= "models/portal_house/p_xs.mdl";
const string DL44_MODEL_GROUND		= "models/portal_house/w_xs.mdl";
const string DL44_MODEL_CLIP		= "models/w_weaponbox.mdl";
const string DL44_MODEL_PROJECTILE	= "models/portal_house/BlasterShootRed.mdl";
...
void RegisterDL44Blaster()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_dl44blaster", "portal_house", "blaster" );
}
