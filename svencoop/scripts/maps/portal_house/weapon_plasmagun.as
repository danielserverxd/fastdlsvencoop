...
const string HREPEATER_SOUND_FIRE		= "portal_house/weapons/plasma2.wav";
const string HREPEATER_SOUND_RELOAD		= "portal_house/weapons/plasma_re.wav";
const string HREPEATER_SOUND_EXPLODE	= "buttons/latchunlocked2.wav";
const string HREPEATER_SOUND_FIREALT	= "ambience/particle_suck1.wav";
const string HREPEATER_SOUND_EXPLODEALT	= "weapons/mortarhit.wav";
const string HREPEATER_SOUND_DRYFIRE	= "weapons/dryfire.wav";

const string HREPEATER_MODEL_NULL		= "models/not_precached.mdl";
const string HREPEATER_MODEL_VIEW		= "models/portal_house/v_plasmagun.mdl";
const string HREPEATER_MODEL_PLAYER		= "models/portal_house/p_plasmagun.mdl";
const string HREPEATER_MODEL_GROUND		= "models/portal_house/w_plasmagun.mdl";
...
class weapon_plasmagun : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "sprites/portal_house/cshoot.spr" );	
		g_Game.PrecacheModel( "sprites/portal_house/plasma.spr" );
...
void RegisterHREPEATER()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_plasmagun", "portal_house", "flechette" );
}
