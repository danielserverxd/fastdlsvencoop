...
const int P904_MAX_AMMO		= 250;
const int P904_MAX_AMMO2 	= 10;
const int P904_MAX_CLIP 		= 50;
const int P904_WEIGHT 		= 5;

class weapon_p904 : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/portal_house/w_p904.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/portal_house/v_p904.mdl" );
		g_Game.PrecacheModel( "models/portal_house/w_p904.mdl" );
		g_Game.PrecacheModel( "models/portal_house/p_p904.mdl" );
		...
		g_SoundSystem.PrecacheSound( "portal_house/weapons/m16burst.wav" );
		g_SoundSystem.PrecacheSound( "portal_house/weapons/m16burst.wav" );
		g_SoundSystem.PrecacheSound( "portal_house/weapons/m16burst.wav" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/portal_house/v_p904.mdl" ), self.GetP_Model( "models/portal_house/p_p904.mdl" ), P904_DEPLOY, "mp5" );
	}
	...
	void PrimaryAttack()
	{
		...
		{
		case 0: self.SendWeaponAnim( P904_FIRE1, 0, 0 ); break;
		case 1: self.SendWeaponAnim( P904_FIRE2, 0, 0 ); break;
		case 2: self.SendWeaponAnim( P904_FIRE3, 0, 0 ); break;
		}
		
		g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "portal_house/weapons/m16burst.wav", 1.0, ATTN_NORM, 0, 95 + Math.RandomLong( 0, 10 ) );
	...
	void SecondaryAttack()
	{
		...
		self.SendWeaponAnim( P904_LAUNCH );
	...
	void Reload()
	{
		self.DefaultReload( P904_MAX_CLIP, P904_RELOAD, 1.5, 0 );
...
void RegisterP904()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_p904", GetP904Name() );
	g_ItemRegistry.RegisterWeapon( GetP904Name(), "portal_house", "9mm", "ARgrenades" );
}
