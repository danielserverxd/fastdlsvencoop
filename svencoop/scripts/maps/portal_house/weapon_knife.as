...
class weapon_knife : ScriptBasePlayerWeaponEntity
{
	...
	{
		self.Precache();
		g_EntityFuncs.SetModel( self, self.GetW_Model( "models/portal_house/w_knife.mdl") );
		self.m_iClip			= -1;
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/portal_house/v_knife.mdl" );
		g_Game.PrecacheModel( "models/portal_house/w_knife.mdl" );
		g_Game.PrecacheModel( "models/portal_house/p_knife.mdl" );
		g_Game.PrecacheModel( "sprites/portal_house/weapon_knife.spr" );
		
		g_Game.PrecacheGeneric( "sprites/portal_house/weapon_knife.spr" );
		g_Game.PrecacheGeneric( "sprites/portal_house/weapon_knife.txt" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/portal_house/v_knife.mdl" ), self.GetP_Model( "models/portal_house/p_knife.mdl" ), KNIFE_DRAW, "crowbar" );
	}
...
void RegisterKnife()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_knife", GetKnifeName() );
	g_ItemRegistry.RegisterWeapon( GetKnifeName(), "portal_house" );
}
