...
const int MP5HL_DEFAULT_GIVE 	= 50;
const int MP5HL_MAX_AMMO		= 250;
const int MP5HL_MAX_AMMO2 	= 10;
const int MP5HL_MAX_CLIP 		= 50;
const int MP5HL_WEIGHT 		= 5;

class weapon_mp5hl : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/portal_house/w_9mmAR.mdl" );

		self.m_iDefaultAmmo = MP5HL_DEFAULT_GIVE;
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/portal_house/v_9mmar.mdl" );
		g_Game.PrecacheModel( "models/portal_house/w_9mmAR.mdl" );
		g_Game.PrecacheModel( "models/portal_house/p_9mmAR.mdl" );
	...
	{
		info.iMaxAmmo1 	= MP5HL_MAX_AMMO;
		info.iMaxAmmo2 	= MP5HL_MAX_AMMO2;
		info.iMaxClip 	= MP5HL_MAX_CLIP;
		info.iSlot 		= 2;
		info.iPosition 	= 7;
		info.iFlags 	= 0;
		info.iWeight 	= MP5HL_WEIGHT;
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/portal_house/v_9mmar.mdl" ), self.GetP_Model( "models/portal_house/p_9mmAR.mdl" ), MP5HL_DEPLOY, "mp5" );
	}
	...
	void PrimaryAttack()
	{
		...
		{
		case 0: self.SendWeaponAnim( MP5HL_FIRE1, 0, 0 ); break;
		case 1: self.SendWeaponAnim( MP5HL_FIRE2, 0, 0 ); break;
		case 2: self.SendWeaponAnim( MP5HL_FIRE3, 0, 0 ); break;
		}
	...
	void SecondaryAttack()
	{
		...
		self.SendWeaponAnim( MP5HL_LAUNCH );
	...
	void Reload()
	{
		self.DefaultReload( MP5HL_MAX_CLIP, MP5HL_RELOAD, 1.5, 0 );
...
void RegisterMP5HL()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_mp5hl", GetMP5HLName() );
	g_ItemRegistry.RegisterWeapon( GetMP5HLName(), "portal_house", "9mm", "ARgrenades" );
}
