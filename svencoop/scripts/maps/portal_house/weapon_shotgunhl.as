...
class weapon_shotgunhl : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/portal_house/w_shotgun.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/portal_house/v_shotgun.mdl" );
		g_Game.PrecacheModel( "models/portal_house/w_shotgun.mdl" );
		g_Game.PrecacheModel( "models/portal_house/p_shotgun.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/portal_house/v_shotgun.mdl" ), self.GetP_Model( "models/portal_house/p_shotgun.mdl" ), SHOTGUN_DRAW, "shotgun" );
	}
...
string GetShotgunHLName()
{
	return "weapon_shotgunhl";
}

void RegisterShotgunHL()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_shotgunhl", GetShotgunHLName() );
	g_ItemRegistry.RegisterWeapon( GetShotgunHLName(), "portal_house", "buckshot" );
}
