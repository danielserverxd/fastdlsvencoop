...
const string T21_MODEL_NULL		= "models/not_precached2.mdl";
...
class weapon_t21blaster : ScriptBasePlayerWeaponEntity
{
	...
	{
		if (@pController == null){
		@pController = SpawnWeaponControllerInPlayer( m_pPlayer, T21_MODEL_PLAYER );
		}
		return self.DefaultDeploy( self.GetV_Model( T21_MODEL_VIEW ), self.GetP_Model( T21_MODEL_NULL ), T21_DRAW, "gauss" );
	...
	void PrimaryAttack()
	{
		...
		{
			case 0:	iAnim = T21_FIRE1;
			self.m_flTimeWeaponIdle = g_Engine.time + 0.4;
			break;
			
			case 1: iAnim = T21_FIRE2;
			self.m_flTimeWeaponIdle = g_Engine.time + 0.4;
			break;
			
			case 2: iAnim = T21_FIRE3;
			self.m_flTimeWeaponIdle = g_Engine.time + 0.4;
			break;
		}
		...
		vecTemp.x -= 1.0f;
		vecTemp.y += 0.5f - (coolDownNum * 0.5f);
	...
	void WeaponIdle()
	{
		...
		{
			case 0:	iAnim = T21_IDLE1;
			self.m_flTimeWeaponIdle = g_Engine.time + 3;
			break;
			
			case 1: iAnim = T21_IDLE2;
			self.m_flTimeWeaponIdle = g_Engine.time + 3;
			break;
		}
...
void RegisterT21Blaster()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_t21blaster", "starwars", "highpowerblaster" );
}
