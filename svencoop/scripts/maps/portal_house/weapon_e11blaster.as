...
const string E11_SOUND_DRAW		= "portal_house/selectRifleBlaster.wav";
const string E11_SOUND_FIRE		= "portal_house/shootRifleBlaster.wav";
const string E11_SOUND_EXPLODE		= "portal_house/hit_wallRifleBlaster.wav";
const string E11_SOUND_DRYFIRE		= "portal_house/dryfire.wav";

const string E11_MODEL_NULL		= "models/portal_house/p_rifleBlaster.mdl";
const string E11_MODEL_VIEW		= "models/portal_house/v_rifleBlaster.mdl";
const string E11_MODEL_PLAYER		= "models/portal_house/p_rifleBlasterNull.mdl";
const string E11_MODEL_GROUND		= "models/portal_house/w_rifleBlaster.mdl";
const string E11_MODEL_CLIP		= "models/w_weaponbox.mdl";
const string E11_MODEL_PROJECTILE	= "models/portal_house/BlasterShootRed.mdl";

const Vector VECTOR_CONE( 0.15, 0.15, 0.00  );		// 5 degrees by 1 degrees
...
class weapon_e11blaster : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "sprites/portal_house/expB1.spr" );
		g_Game.PrecacheModel( "sprites/redflare1.spr" );
		g_Game.PrecacheModel( "sprites/white.spr" );
		g_Game.PrecacheModel( "sprites/portal_house/blasterboltred.spr" );
		g_Game.PrecacheModel( "sprites/portal_house/blasterimpact.spr" );
...
void RegisterE11Blaster()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_e11blaster", "portal_house", "blaster" );
}
