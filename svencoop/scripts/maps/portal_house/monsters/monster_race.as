...
* Call race::Register() to register this entity.
* Entity classname: monster_race
*/
...
class CMonsterrace : ScriptBaseMonsterEntity
{
	...
	CMonsterrace()
	{
		@this.m_Schedules = @monster_race_schedules;
	}
	...
	void raceFireE11()
	{
		...
		Vector randomDir = Vector(Math.RandomFloat(-150,150),Math.RandomFloat(-150,150),Math.RandomFloat(-100,400));

		if(m_justReloaded){
		randomDir = Vector(0,0,10);
		}
		
		ShootBlasterNpc( 19, self.pev, vecShootOrigin, vecShootDir * 3500 + randomDir );
		...
		g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_WEAPON, HREPEATER_SOUND_FIRE, 1, ATTN_NORM, 0, PITCH_NORM + pitchShift );

		if( self.pev.movetype != MOVETYPE_FLY && self.m_MonsterState != MONSTERSTATE_PRONE )
		{
			self.m_flAutomaticAttackTime = g_Engine.time + Math.RandomFloat(-0.5, -0.5);
		}
	...
	void Precache()
	{
		...
		if( string( self.pev.model ).IsEmpty() )
		{
			...
			if( self.IsPlayerAlly() )
				g_Game.PrecacheModel("models/portalhouse/race.mdl");
			else
				g_Game.PrecacheModel("models/portal_house/race.mdl");
		}

		g_SoundSystem.PrecacheSound("portal_house/race/race_alert1.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_alert2.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_idle2.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_idle3.wav");
		
		g_SoundSystem.PrecacheSound("portal_house/race/race_die1.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_die2.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_pain5.wav");

		g_SoundSystem.PrecacheSound("portal_house/race/race_pain1.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_pain2.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_pain3.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_pain4.wav");
		
		g_SoundSystem.PrecacheSound("portal_house/race/race_idle3.wav");
		g_SoundSystem.PrecacheSound("portal_house/race/race_idle4.wav");
	...
	void Spawn()
	{
		...
		m_cClipSize					= 40; //40 Shots
		self.m_cAmmoLoaded			= m_cClipSize;

		if( string( self.m_FormattedName ).IsEmpty() )
		{
			if( self.IsPlayerAlly() )
				self.m_FormattedName = "race";
			else
				self.m_FormattedName = "race";
		}
	...
	{
		if( self.IsPlayerAlly() )
			g_EntityFuncs.SetModel( self, "models/portal_house/race.mdl" );
		else
			g_EntityFuncs.SetModel( self, "models/portal_house/race.mdl" );
	}
	...
	void FearScream()
	{
		if( m_flNextFearScream < g_Engine.time )
		{
			...
			{
			case 0: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_alert1.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: break;
			case 2: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_alert2.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: break;
			case 4: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_idle2.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
			case 5: break;
			case 6: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_idle3.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
			case 7: break;
			}
	...
	void PainSound()
	{
		...
		{
		case 0: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_pain1.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 1: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_pain2.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 2: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_pain3.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 3: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_pain4.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		}
	}
	...
	void DeathSound()
	{
		...
		{
		case 0: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_die1.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 1: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_die2.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 2: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_pain5.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		}
	}
	...
	void VictorySound()
	{
		switch (Math.RandomLong(0,3))
		{
		case 0: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_idle3.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 1: break;
		case 2: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_idle4.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 3: break;
		}
	}
	...
	void FollowerUse( CBaseEntity@ pActivator, CBaseEntity@ pCaller, USE_TYPE useType, float flValue )
	{
		...
		{
			g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_idle4.wav", 1, ATTN_NORM, 0, PITCH_NORM);
		}
		else
			g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portal_house/race/race_idle2.wav", 1, ATTN_NORM, 0, PITCH_NORM);
	}
}

array<ScriptSchedule@>@ monster_race_schedules;
...
{
	InitSchedules();
	g_CustomEntityFuncs.RegisterCustomEntity( "race::CMonsterrace", "monster_race" );
}
