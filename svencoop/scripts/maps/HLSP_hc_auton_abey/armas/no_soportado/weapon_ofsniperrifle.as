...
class weapon_ofsniperrifle : ScriptBasePlayerWeaponEntity, WeaponUtils
{
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel('models/hc_auton_abey/sd/v_m40a1.mdl');
  ...
  bool Deploy()
  {
    bool bResult = self.DefaultDeploy(self.GetV_Model('models/hc_auton_abey/sd/v_m40a1.mdl'), self.GetP_Model('models/valve/sd/p_m40a1.mdl'), DRAW, 'sniper');
