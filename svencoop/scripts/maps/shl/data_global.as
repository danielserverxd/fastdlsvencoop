...
void WriteLineToFile()
{
	...
	try 
	{
		File@ file = g_FileSystem.OpenFile("scripts/maps/store/shlGlobal.txt", OpenFile::READ);
	...
	File@ file= g_FileSystem.OpenFile("scripts/maps/store/shlGlobal.txt", OpenFile::WRITE);
