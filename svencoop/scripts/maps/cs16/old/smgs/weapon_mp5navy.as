...
// Models
const string W_MODEL 	= "models/cs16/mp5navy/w_mp5.mdl";
const string V_MODEL 	= "models/cs16/mp5navy/v_mp5.mdl";
const string P_MODEL 	= "models/cs16/mp5navy/p_mp5.mdl";
// Sounds
const string SHOOT_1S 	= "weapons/cs16/mp5-1.wav";
const string SHOOT_2S 	= "weapons/cs16/mp5-2.wav";
// Information
...
class weapon_mp5navy : ScriptBasePlayerWeaponEntity, CS16BASE::WeaponBase
{
	...
	private array<string> Sounds = {
		"weapons/cs16/mp5_slideback.wav",
		"weapons/cs16/mp5_clipin.wav",
		"weapons/cs16/mp5_clipout.wav",
		SHOOT_1S,
		SHOOT_2S
	};
	...
	bool Deploy()
	{
		return Deploy( V_MODEL, P_MODEL, MP5Navy_DRAW, "mp5", GetBodygroup(), (30.0/35.0) );
	}
	...
	void PrimaryAttack()
	{
		...
		self.m_flNextPrimaryAttack = WeaponTimeBase() + GetFireRate( 750 );
		...
		self.SendWeaponAnim( MP5Navy_SHOOT1 + Math.RandomLong( 0, 2 ), 0, GetBodygroup() );
	...
	void Reload()
	{
		...
		Reload( MAX_CLIP, MP5Navy_RELOAD, (100.0/38.0), GetBodygroup() );
	...
	void WeaponIdle()
	{
		...
		self.SendWeaponAnim( MP5Navy_IDLE, 0, GetBodygroup() );
...
void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "CS_MP5::weapon_mp5navy", GetName() ); // Register the weapon entity
