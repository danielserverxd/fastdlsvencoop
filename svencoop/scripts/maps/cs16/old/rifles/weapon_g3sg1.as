...
// Models
const string W_MODEL 	= "models/cs16/g3sg1/w_g3sg1.mdl";
const string V_MODEL 	= "models/cs16/g3sg1/v_g3sg1.mdl";
const string P_MODEL 	= "models/cs16/g3sg1/p_g3sg1.mdl";
// Sounds
const string SHOOT_S 	= "weapons/cs16/g3sg1-1.wav";
// Information
...
class weapon_g3sg1 : ScriptBasePlayerWeaponEntity, CS16BASE::WeaponBase
{
	...
	private array<string> Sounds = {
		"weapons/cs16/g3sg1_slide.wav",
		"weapons/cs16/g3sg1_clipout.wav",
		"weapons/cs16/g3sg1_clipin.wav",
		SHOOT_S
	};
	...
	bool Deploy()
	{
		return Deploy( V_MODEL, P_MODEL, G3SG1_DRAW, "m16", GetBodygroup(), (30.0/30.0) );
	}
	...
	void PrimaryAttack()
	{
		...
		self.SendWeaponAnim( G3SG1_SHOOT1 + Math.RandomLong( 0, 1 ), 0, GetBodygroup() );
	...
	void Reload()
	{
		...
		Reload( MAX_CLIP, G3SG1_RELOAD, (140.0/30.0), GetBodygroup() );
	...
	void WeaponIdle()
	{
		...
		self.SendWeaponAnim( G3SG1_IDLE, 0, GetBodygroup() );
...
void Register()
{
	...
	g_CustomEntityFuncs.RegisterCustomEntity( "CS_G3SG1::weapon_g3sg1", GetName() ); // Register the weapon entity
