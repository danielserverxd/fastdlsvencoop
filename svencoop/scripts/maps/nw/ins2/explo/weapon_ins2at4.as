...
string V_MODEL = "models/nw/ins2/wpn/at4/v_at4.mdl";
...
class weapon_ins2at4 : ScriptBasePlayerWeaponEntity, NWINS2BASE::WeaponBase, NWINS2BASE::ExplosiveBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "rpg", GetBodygroup(), (104.0/51.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "rpg", GetBodygroup(), (29.0/35.0) );
	}
	...
	void ShootThink()
	{
		...
		NWINS2ROCKETPROJECTILE::CIns2Rocket@ pRocket = NWINS2ROCKETPROJECTILE::ShootRocket( m_pPlayer.pev, vecStart, vecVeloc, R_MODEL, DAMAGE, PROJ_NAME );
	...
	void Reload()
	{
		...
		{
			Reload( MAX_CLIP, RELOAD, (146.0/50.0), GetBodygroup() );
			SetThink( ThinkFunction( EjectClipThink ) );
			self.pev.nextthink = g_Engine.time + (40.0/50.0);
			canReload = false;
		}
