...
class weapon_brush : weapon_uboamelee {
	...
	void PrimaryAttack() {
	    ...
	    float spdBuf = (mRageLevel > 0) ? 0.2 : 0.45;
	...
	void SecondaryAttack() {
	    ...
	    float spdBuf = (mRageLevel > 0) ? 0.3 : 0.45;
...
void RegisterBrush() {
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_brush", GetBrushName() );
	g_ItemRegistry.RegisterWeapon( GetBrushName(), "uboa_rampage", DURABILITY_AMMO_NAME, UBOAKIAI_AMMO_NAME);
}
