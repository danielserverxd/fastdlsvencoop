...
class weapon_ironpipe : weapon_uboamelee {
	...
	void PrimaryAttack() {
	    ...
	    float dmgBuf = 34.0 + Math.RandomFloat(0.0, 3.0) + (0.5 * mRageLevel);
	...
	void SecondaryAttack() {
	    // Rageモードと合わせてスピード、威力調整
	    float dmgBuf = 51.0 + (0.6 * mRageLevel);
...
void RegisterIronpipe() {
	...
	g_ItemRegistry.RegisterWeapon( GetIronpipeName(), "uboa_rampage", DURABILITY_AMMO_NAME, UBOAKIAI_AMMO_NAME);
}
