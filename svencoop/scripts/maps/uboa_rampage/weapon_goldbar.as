...
class weapon_goldbar : weapon_uboamelee {
...
string GetGoldbarName() {
	return "weapon_goldbar";
}

void RegisterGoldbar() {
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_goldbar", GetGoldbarName() );
	g_ItemRegistry.RegisterWeapon( GetGoldbarName(), "uboa_rampage", DURABILITY_AMMO_NAME, UBOAKIAI_AMMO_NAME);
}
