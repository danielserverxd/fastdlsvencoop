...
class weapon_bat : weapon_uboamelee {
	...
	void PrimaryAttack() {
	    ...
	    float dmgBuf = 31.0 + Math.RandomFloat(0.0, 3.0) + (0.5 * mRageLevel);
...
void RegisterBat() {
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_bat", GetBatName() );
	g_ItemRegistry.RegisterWeapon( GetBatName(), "uboa_rampage", DURABILITY_AMMO_NAME, UBOAKIAI_AMMO_NAME);
}
